                    ...
                    <div className={"first"}>
                        <div className={"row"}>
                            ...
                            <div className={"col-3"}>
                                ...
                                <div className={"position active"}><a href='/ourteam'>Our Team</a></div>
                                <div className={"position active"}><a href='/#'>F.A.Q</a></div>
                            ...
                            <div className={"col-3"}>
                                ...
                                <div className={"position active"}><a href='/jobs'>JOBS</a></div>
